...
<section>
    ...
    <form method="post" action="recipies">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" placeholder="Enter name" value="${recipe.name}" name="name" required>
        </div>

        <div class="form-group">
        <label for="description">Описание</label>
        <input type="text" class="form-control" id="description" placeholder="Enter description" value="${recipe.description}" name="description" required>
    </div>

        <div class="form-group">
            <label for="cookAlgorithm">Алгоритм приготовления</label>
            <input type="text" class="form-control" id="cookAlgorithm" placeholder="Enter cookAlgorithm" value="${recipe.cookAlgorithm}" name="cookAlgorithm" required>
        </div>
